...
namespace WebAPI.Controllers
{
    ...
    public class PacienteController : MiControllerBase
    {
        ...
        [HttpPost("Crear")]
        public async Task<ActionResult<MediatR.Unit>> Crear(NuevoPaciente.EjecutaPaciente data)
        {
            return await Mediator.Send(data);
        }

        //[HttpPut("{id}")]
        //public async Task<ActionResult<Unit>> Editar(Guid id, Editar.EjecutaMedico data)
        //{
        //    data.IdTblMedico = id;
